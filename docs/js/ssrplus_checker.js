...
// var sakuraMusicNameArray = ["サイレントマジョリティー","ガラスを割れ！","二人セゾン","Nobody","アンビバレント","風に吹かれても", "世界には愛しかない"];
// var hinataMusicNameArray = ["キュン","JOYFUL LOVE","期待していない自分","君に話しておきたいこと","ハッピーオーラ","キツネ", "ドレミソラシド"];
var sakuraMusicNameArray = ["誰がその鐘を鳴らすのか？"];
var hinataMusicNameArray = ["こんなに好きになっちゃっていいの？"];
